...
const translations = {
  en: {
    ...
    hero: {
      ...
      title2: "Cloud Platform",
      // desc: "Amanrow ERP is a modern cloud platform that helps organizations streamline legal operations, manage debt collection workflows, and oversee human resource management — all from a single integrated system designed for efficiency, transparency, and scalable growth.",
      desc: "Amanrow ERP is a modern cloud-based platform designed to help organizations streamline legal operations, manage debt collection workflows, and oversee human resource management — all within a single, fully integrated system.\n\nBy unifying critical business functions into one centralized environment, Amanrow enables organizations to improve operational efficiency, enhance transparency, and maintain complete control over their processes. With intelligent workflow automation, structured data management, and secure cloud access, teams can collaborate more effectively, reduce administrative complexity, and make informed decisions that support sustainable and scalable growth.",
    },
    solutions: {
      heading: "Our ERP Solutions",
      subheading: "Amanrow ERP Solutions",
  ...
  return (
    <main className="min-h-screen bg-white text-gray-900" dir={dir}>
      ...
      <header className="flex justify-between items-center px-10 py-4 border-b bg-white">
        ...
        <nav className="hidden md:flex items-center gap-8">
          <a href="#solutions" className="text-gray-600 hover:text-black">{t.nav.products}</a>
          <a href="#features" className="text-gray-600 hover:text-black">{t.nav.features}</a>
          <a href="#contact" className="text-gray-600 hover:text-black">{t.nav.contact}</a>
          <button
            onClick={() => {
              const newLang = lang === "en" ? "ar" : "en";
              setLang(newLang);
      ...
      {menuOpen && (
        <div className="md:hidden bg-white border-b px-10 py-4 space-y-4">
          <a href="#solutions" className="block text-gray-600">{t.nav.products}</a>
          <a href="#features" className="block text-gray-600">{t.nav.features}</a>
          <a href="#contact" className="block text-gray-600">{t.nav.contact}</a>
        </div>
      )}
      ...
      <section id="solutions" className="py-28 px-10 bg-white text-center">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-gray-800 mb-3">{t.solutions.heading}</h2>
          <p className="text-orange-500 font-semibold mb-4">{t.solutions.subheading}</p>
          <p className="text-gray-500 max-w-2xl mx-auto mb-14">{t.solutions.desc}</p>
          <div className="w-16 h-[2px] bg-gray-300 mx-auto mb-16"></div>
          <div className="grid md:grid-cols-3 gap-14 text-left">
            <div>
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 flex items-center justify-center rounded-full border-2 border-orange-400 text-orange-500">⚖️</div>
                <h3 className="text-lg font-semibold text-gray-700">{t.solutions.lawcase.title}</h3>
              </div>
              <p className="text-gray-500 mb-4 leading-relaxed">{t.solutions.lawcase.desc}</p>
              <a href="/lawcase" className="text-orange-500 font-medium hover:underline">{t.solutions.lawcase.link}</a>
            </div>
            <div>
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 flex items-center justify-center rounded-full border-2 border-orange-400 text-orange-500">💬</div>
                <h3 className="text-lg font-semibold text-gray-700">{t.solutions.debt.title}</h3>
              </div>
              <p className="text-gray-500 mb-4 leading-relaxed">{t.solutions.debt.desc}</p>
              <a href="/debt-collection" className="text-orange-500 font-medium hover:underline">{t.solutions.debt.link}</a>
            </div>
            <div>
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 flex items-center justify-center rounded-full border-2 border-orange-400 text-orange-500">👥</div>
                <h3 className="text-lg font-semibold text-gray-700">{t.solutions.hr.title}</h3>
              </div>
              <p className="text-gray-500 mb-4 leading-relaxed">{t.solutions.hr.desc}</p>
              <a href="/hr" className="text-orange-500 font-medium hover:underline">{t.solutions.hr.link}</a>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="py-28 px-10 bg-gray-50">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-gray-800 mb-3">{t.why.heading}</h2>
          <p className="text-gray-500 max-w-2xl mx-auto mb-16">{t.why.desc}</p>
          <div className="grid md:grid-cols-3 gap-10">
            {t.why.cards.map((card, i) => (
              <div key={i} className="bg-white p-8 rounded-xl shadow-sm hover:shadow-xl transition">
                <div className="text-4xl mb-4">{card.icon}</div>
      ...
      <section id="contact" className="py-28 px-10 bg-gray-50">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16">
          ...
          {/* LEFT SIDE */}
          <div>
            <h2 className="text-4xl font-bold mb-6">{t.contact.heading}</h2>
            <p className="text-gray-600 mb-10">{t.contact.desc}</p>
            <div className="space-y-8">
              <div>
                <h3 className="font-semibold text-lg">{t.contact.office}</h3>
                <p className="text-gray-600">{t.contact.officeVal}</p>
              ...
              <div>
                <h3 className="font-semibold text-lg">{t.contact.hours}</h3>
                <p className="text-gray-600" style={{ whiteSpace: "pre-line" }}>{t.contact.hoursVal}</p>
              </div>
            </div>
          </div>
            ...
            {sent ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  type="submit"
                  disabled={sending}
                  className="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition w-full disabled:opacity-60"
                >
